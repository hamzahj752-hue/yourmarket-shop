...
export default function Hero() {
  return (
    <section className="relative overflow-hidden border-b border-border">
      ...
      <div className="relative mx-auto grid w-full max-w-7xl gap-10 px-4 py-14 sm:gap-12 sm:px-6 sm:py-20 lg:grid-cols-2 lg:items-center lg:gap-8 lg:px-8 lg:py-24">
        <div className="max-w-xl">
          ...
          <h1 className="mt-6 text-3xl font-black leading-[1.1] tracking-tight sm:text-5xl sm:leading-[1.05] lg:text-6xl xl:text-7xl">
            Style That
            <br />
            Speaks For{" "}
